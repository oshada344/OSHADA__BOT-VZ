...
async function connectToWA() {
  console.log("Connecting OSHADA-MD 🧬...");
  ...
  danuwa.ev.on('connection.update', async (update) => {
    ...
    if (connection === 'close') {
      ...
      console.log('✅ OSHADA-MD connected to WhatsApp');

      const up = `OSHADA-MD connected ✅\n\nPREFIX: ${prefix}`;
...
app.get("/", (req, res) => {
  res.send("Hey, OSHADA-MD started✅");
});
